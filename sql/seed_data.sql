-- =====================================================================
-- Online Computer Shop - demo data for local testing
--
-- Import onlinecomputershop.sql (the shared schema) FIRST, then this file.
-- Nothing here changes the schema: it only inserts rows so Task 4 has
-- products, customers, reviews and a cart to work with while Tasks 1-3
