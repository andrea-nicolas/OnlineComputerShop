<?php
require_once __DIR__ . "/../control/admin_dashboard_control.php";
...
<?php } else { ?>
    ...
    <div class="card">
        <div class="page-head" style="margin-bottom:12px;">
            ...
            <a class="small" href="<?php echo link_to('/view/admin_reviews.php'); ?>">Manage all reviews &rarr;</a>
        </div>
    ...
    <p>
        <a class="btn btn-light" href="<?php echo link_to('/view/admin_customers.php'); ?>">Manage customers</a>
        <a class="btn btn-light" href="<?php echo link_to('/view/admin_reviews.php'); ?>">Manage reviews</a>
    </p>
